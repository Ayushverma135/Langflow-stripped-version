...
# JFrog Credetials 
ARG DEVSTACK_JFROG_USER 
ARG DEVSTACK_JFROG_PASSWORD 
ENV UV_INDEX_INTERNAL_PYPI_USERNAME=$DEVSTACK_JFROG_USER 
ENV UV_INDEX_INTERNAL_PYPI_PASSWORD=$DEVSTACK_JFROG_PASSWORD
